...
output_dir = f"results_{today}_240_neruons_4_8"
...
list_train = pd.read_csv("/mnt/users/hastabbe/e-prop_master_nmbu/code_accumelated/orion_scripts_train_4_8_val/encoded_long_list.csv")
